...
export type GetCustomersQuery = { __typename?: 'Query', customers?: { __typename?: 'PagedCustomersResponse', total: number, results: Array<{ __typename?: 'Customer', id: string, email: string, name: string, photoUrl?: string | null }> } | null };
