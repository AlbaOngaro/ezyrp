...
export type BookingQuery = { __typename?: 'Query', booking?: { __typename?: 'Booking', id: string, days: Array<number>, name: string, slots: Array<string>, duration: number, description?: string | null } | null };
